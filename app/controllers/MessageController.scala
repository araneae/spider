...
object MessageController extends Controller with Secured {
  ...
  def get(messageId: Long) = IsAuthenticated{ username => implicit request =>
  ...
  def delete(messageId: Long) = IsAuthenticated{ username => implicit request =>
  ...
  def markStar(messageId: Long) = IsAuthenticated{ username => implicit request =>
  ...
  def removeStar(messageId: Long) = IsAuthenticated{ username => implicit request =>
  ...
  def markImportant(messageId: Long) = IsAuthenticated{ username => implicit request =>
  ...
  def removeImportant(messageId: Long) = IsAuthenticated{ username => implicit request =>
  ...
  def markRead(messageId: Long) = IsAuthenticated{ username => implicit request =>
  ...
  def reply(messageId: Long) = IsAuthenticated(parse.json){ username => implicit request =>
  ...
  def trash(messageId: Long) = IsAuthenticated{ username => implicit request =>
  ...
  def move(messageId: Long, messageBoxId: Long) = IsAuthenticated{ username => implicit request =>
