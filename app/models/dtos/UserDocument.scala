...
object UserDocument extends Function12[Long, Long, OwnershipType, Boolean, Boolean, Boolean, Boolean, Long, DateTime, Option[DateTime], Option[Long], Option[DateTime], UserDocument]
{
