    ...
    .config ($stateProvider, $urlRouterProvider, $httpProvider) ->
       ...
       $stateProvider
          ...
          .state('subscriptionEdit', {
              url: '/admin/subscription/:subscriptionId/edit'
              views: {
                'viewHeaderBar': {
                  templateUrl: '/assets/partials/headerBarHome.html'
                },
                ...
                'viewMain': {
                    templateUrl: '/assets/partials/subscriptionEdit.html'
                }
              },
              permission: {
                name: 'site.admin'
          ...
          .state('subscriptionPermissions', {
              ...
              views: {
                ...
                'viewMain': {
                    templateUrl: '/assets/partials/subscriptionPermission.html'
                }
              },
              permission: {
                name: 'site.admin'
